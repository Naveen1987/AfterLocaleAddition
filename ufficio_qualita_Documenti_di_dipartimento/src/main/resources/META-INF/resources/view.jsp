...
<table class="table table-hover table-bordered results">
  <thead>
    ...
    <tr class="warning no-result">
      <td colspan="6"><i class="fa fa-warning"></i> <liferay-ui:message key="noresult"/></td>
    </tr>
  </thead>
  <tbody>
<%
...
<td><aui:a href="<%=record.getDownloadUrl()%>" style="color:black;text-decoration:none;"><%=getValue(dipartimento)%></aui:a></td>
