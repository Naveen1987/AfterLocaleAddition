...
List<FileLibInfo> records=fsfl.getRecords("Affari Generali e Legali", themeDisplay,locale);
...
<td><aui:a href="<%=record.getDownloadUrl()%>" style="color:black;text-decoration:none;"><%=record.getModifiedDate()%></aui:a></td>
<td>
